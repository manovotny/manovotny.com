...
<img
    title="PhpStorm reveal tool windows keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-reveal-tool-windows.gif`}
/>
...
<img
    title="PhpStorm find action keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-find-action.gif`}
/>
...
<img
    title="PhpStorm navigate file keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-navigate-file.gif`}
/>
...
<img
    title="PhpStorm rename keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-rename.gif`}
/>
...
<img
    title="PhpStorm show intention actions keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-show-intention-actions.gif`}
/>
...
<img
    title="PhpStorm open terminal keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-open-terminal.gif`}
/>
...
<img
    title="PhpStorm new keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-new.gif`}
/>
...
<img
    title="PhpStorm find in path keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-find-in-path.gif`}
/>
...
<img
    title="PhpStorm paste from histroy keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-paste-from-history.gif`}
/>
...
<img
    title="PhpStorm move line up and down keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-move-line-up-and-down.gif`}
/>
...
<img
    title="PhpStorm move statement up and down keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-move-statement-up-and-down.gif`}
/>
...
<img
    title="PhpStorm debugging keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-debugging.gif`}
/>
...
<img
    title="PhpStorm extend and shrink selection keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-extend-and-shrink-selection.gif`}
/>
...
<img
    title="PhpStorm extract variable keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-extract-variable.gif`}
/>
...
<img
    title="PhpStorm extract method keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-extract-method.gif`}
/>
...
<img
    title="PhpStorm inline keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-inline.gif`}
/>
...
<img
    title="PhpStorm duplicate line or block keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-duplicate-line-or-block.gif`}
/>
...
<img
    title="PhpStorm delete line keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-delete-line.gif`}
/>
...
<img
    title="PhpStorm code completion keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-code-completion.gif`}
/>
...
<img
    title="PhpStorm keymap searching screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keymap-searching.gif`}
/>
...
<img
    title="PhpStorm split vertically keyboard shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-split-vertically.gif`}
/>
...
<img
    title="PhpStorm hide and reveal tool windows mouse shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-mouse-shortcut-hide-and-reveal-tool-windows.gif`}
/>
...
<img
    title="PhpStorm redistribute editor windows mouse shortcut screencast"
    src={`/images/phpstorm-keyboard-shortcuts/phpstorm-mouse-shortcut-redistribute-editor-windows.gif`}
/>
