...
image: '/static/images/phpstorm-keyboard-shortcuts/featured-image.jpg',
...
![PhpStorm reveal tool windows keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-reveal-tool-windows.gif)
...
![PhpStorm find action keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-find-action.gif)
...
![PhpStorm navigate file keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-navigate-file.gif)
...
![PhpStorm rename keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-rename.gif)
...
![PhpStorm show intention actions keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-show-intention-actions.gif)
...
![PhpStorm open terminal keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-open-terminal.gif)
...
![PhpStorm new keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-new.gif)
...
![PhpStorm find in path keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-find-in-path.gif)
...
![PhpStorm paste from histroy keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-paste-from-history.gif)
...
![PhpStorm move line up and down keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-move-line-up-and-down.gif)
...
![PhpStorm move statement up and down keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-move-statement-up-and-down.gif)
...
Once you <Link slug="setup-phpstorm-xdebug-mamp-debugging" title="How To Setup and Configure PhpStorm, Xdebug, and MAMP for Debugging" underline={true}>setup and launch a debugging session</Link>, I use these shortcuts to navigate through the code with ease.

![PhpStorm debugging keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-debugging.gif)
...
![PhpStorm extend and shrink selection keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-extend-and-shrink-selection.gif)
...
![PhpStorm extract variable keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-extract-variable.gif)
...
![PhpStorm extract method keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-extract-method.gif)
...
![PhpStorm inline keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-inline.gif)
...
![PhpStorm duplicate line or block keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-duplicate-line-or-block.gif)
...
![PhpStorm delete line keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-delete-line.gif)
...
![PhpStorm code completion keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-code-completion.gif)
...
![PhpStorm keymap searching screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keymap-searching.gif)
...
![PhpStorm split vertically keyboard shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-keyboard-shortcut-split-vertically.gif)
...
![PhpStorm hide and reveal tool windows mouse shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-mouse-shortcut-hide-and-reveal-tool-windows.gif)
...
![PhpStorm redistribute editor windows mouse shortcut screencast](/static/images/phpstorm-keyboard-shortcuts/phpstorm-mouse-shortcut-redistribute-editor-windows.gif)
