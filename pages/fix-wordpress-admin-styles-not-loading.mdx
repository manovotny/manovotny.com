...
image: '/static/images/fix-wordpress-admin-styles-not-loading/featured-image.jpg',
...
![Screenshot of WordPress admin styles not loading](/static/images/fix-wordpress-admin-styles-not-loading/wordpress-admin-missing-styles.jpg)

WordPress admin CSS styles missing.

All the WordPress admin styles were not loading.

Great. This was not what I had planned for my evening... \*_sigh_\*
