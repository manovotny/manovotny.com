...
<figure>
  <div className="p-2 rounded-lg border border-neutral-200 bg-white shadow-xs dark:border-neutral-700 dark:bg-neutral-800">
    <Image
  ...
  <figcaption className="pt-4 text-sm text-center text-neutral-500 dark:text-neutral-400">
