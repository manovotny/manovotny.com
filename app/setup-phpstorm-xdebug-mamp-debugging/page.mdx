...
export const meta = {
    ...
    image: '/images/setup-phpstorm-xdebug-mamp-debugging/featured-image.jpg',
...
![Activate Xdebug in MAMP](/images/setup-phpstorm-xdebug-mamp-debugging/mamp-pro-activate-xdebug.jpg)
...
![MAMP default PHP version](/images/setup-phpstorm-xdebug-mamp-debugging/mamp-pro-default-php-version.jpg)
...
![MAMP PHP versions per host](/images/setup-phpstorm-xdebug-mamp-debugging/mamp-pro-hosts-php-version.jpg)
...
![PhpStorm Xdebug configuration](/images/setup-phpstorm-xdebug-mamp-debugging/phpstorm-php-xdebug-configuration.gif)

Once this is complete, you should see the Debug configuration you just created in the upper right part of PhpStorm.

![PhpStorm debug icon](/images/setup-phpstorm-xdebug-mamp-debugging/phpstorm-debug.jpg)
...
![PhpStorm debug breakpoint example](/images/setup-phpstorm-xdebug-mamp-debugging/phpstorm-breakpoint-example.jpg)
